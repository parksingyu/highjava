...
public class T02_EnumTest {
	...
	/*
		열거형에서 사용되는 메서드
		1. name() => 열거형 상수의 이름을 문자로 반환한다.
		2. ordinal() => 열거형 상수가 정의된 수서값을 반환한다.(0부터 시작함)
		3. valueOf("열거형상수이름"); => 지정된 열거형에서 '열거형 상수이름'과 일치하는 열거형 상수를 반환한다.
	*/
		...
		// 열거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); // City enum에서 '서울'
