...
class Desc implements Comparator<String>{
	...
	/*
		...
		- String 객체에는 정렬을 위해서 compareTo()에 메서드가 구현되어 있는데
		  이 메서드의 반환값ㄱ은 오름차순에 맞게 반환되도록 구현되어 있다.
	...
	public int compare(String str1, String str2) {
		...
		//return str1.compareTo(str2) * 1;  // 정상적으로 오름차순 정렬
		return str1.compareTo(str2) * -1;  // -1을 하면 내림차순 정렬
	}
}
